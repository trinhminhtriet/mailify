...
mod tests {
    ...
    fn should_interpolate_template_name() {
        assert_eq!(
            interpolate(
                "https://raw.githubusercontent.com/trinhminhtriet/mailify/main/template/",
                "user-login"
            ),
            "https://raw.githubusercontent.com/trinhminhtriet/mailify/main/template/user-login/metadata.json"
        );
    }
