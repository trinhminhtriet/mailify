...
COPY --from=builder /code/target/release/mailify /mailify

FROM alpine:3

LABEL org.label-schema.schema-version="1.0"
LABEL org.label-schema.docker.cmd="docker run -d -p 3000:3000 -e TEMPLATE__TYPE=LOCAL -e TEMPLATE__PATH=/templates -e SMTP__HOSTNAME=localhost -e SMTP__PORT=25 -e SMTP__USERNAME=username -e SMTP__PASSWORD=password -e SMTP__MAX_POOL_SIZE=10 trinhminhtriet/mailify"
LABEL org.label-schema.vcs-url="https://trinhminhtriet.com"
LABEL org.label-schema.url="https://github.com/trinhminhtriet/mailify"
LABEL org.label-schema.description="Service to convert mrml to html and send it by email"
LABEL maintaner="Triet Trinh <contact@trinhminhtriet.com>"
...
COPY --from=builder /code/target/release/mailify /usr/bin/mailify
