...
use mailify::service::{server, smtp};
use testcontainers::clients::Cli as DockerCli;
use testcontainers::core::WaitFor;
use testcontainers::GenericImage;
use tower::ServiceExt;

fn engine_config() -> mailify_engine::Config {
    mailify_engine::Config {
        loader: mailify_engine::loader::Config {
            local: mailify_engine::loader::local::Config {
...
async fn should_submit_simple() {
    let _ = mailify::init_logs("debug", false);
